...
1. [Download Neo4j 3.1.3](http://neo4j.com/download-thanks/?edition=community&release=3.1.3&flavour=unix)
2. unzip to a location
3. [Download GraphAware](http://graphaware.com/downloads/graphaware-server-all-3.1.3.45.jar) and place into `plugins` of Neo4j
