...
1. [Download Neo4j 2.2.1](http://neo4j.com/download-thanks/?edition=community&release=2.2.1&flavour=unix)
2. unzip to a location
3. [Download GraphAware](http://graphaware.com/downloads/graphaware-server-community-all-2.2.1.30.jar) and place into `plugins` of Neo4j
