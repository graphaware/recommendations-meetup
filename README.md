...
1. [Download Neo4j 3.3.1](http://neo4j.com/download-thanks/?edition=community&release=3.3.1&flavour=unix)
2. unzip to a location
3. [Download GraphAware](http://graphaware.com/downloads/graphaware-server-all-3.3.1.51.jar) and place into `plugins` of Neo4j
